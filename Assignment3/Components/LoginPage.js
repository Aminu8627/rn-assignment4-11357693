...
function LoginPage() {
  return (
    ...
    <View style={styles.formInputSection}> 
      <TextInput placeholder='Name' style={styles.nameInputSection} />
      <TextInput placeholder='Email' style={styles.emailInputSection} />
      <View style={styles.loginButton}>
      <Link push  href='./Homepage'>
      <Button  title='Login' color='#356899' width='300px'/>
      </Link>
      </View>
  </View>
...
<Text style={styles.registerLink}>Haven’t an account? <Text>Register</Text></Text>
